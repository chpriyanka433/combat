...
if(yesCount>3){
  AsyncStorage.setItem("resultlevel32", "Highly");
  AsyncStorage.setItem("levelStatus", "Completed");
}
else if(yesCount>2){
  AsyncStorage.setItem("resultlevel32", "Medium level");
}
else if(yesCount>1){
  AsyncStorage.setItem("resultlevel32", "Low level");
}
else{
    ...
    <View style={styles.container}>
      <SafeAreaView>
        ...
        <View style={{ backgroundColor: '#2843de', height: hp(4), width: wp(35), alignSelf: 'center',  alignItems: 'center', marginTop: 10, marginBottom: 10, borderRadius: 5 }}>
          <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#ffffff',marginTop:5 }}>Level- 3.2</Text>
        </View>
