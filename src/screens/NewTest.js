...
if(yesCount>2){
  AsyncStorage.setItem("result", "High");
  ...
  return (
    <View style={styles.container}>
      <SafeAreaView>
        ...
        <View style={{ backgroundColor: '#2843de', height: hp(4), width: wp(35), alignSelf: 'center', padding: 0, alignItems: 'center', marginTop: 10, marginBottom: 10, borderRadius: 5 }}>
          <Text style={{ fontSize: 14, fontWeight: 'bold', color: '#ffffff',marginTop:4 }}>Level- 1.0</Text>
        </View>
