...
const TestSummary = () => {
    ...
    AsyncStorage.getItem('PId').then((valid) => {
      ...
      AsyncStorage.getItem('levelStatus').then((valid) => {
        // console.warn("PID value is",valid) result
        setlevelStatus(valid)
      });
      AsyncStorage.getItem('result').then((valid) => {
        // console.warn("PID value is",valid) result
        setResult(valid)
      });
      AsyncStorage.getItem('resultlevel2').then((valid) => {
        // console.warn("PID value is",valid) result
        setResult2(valid)
      });
      AsyncStorage.getItem('resultlevel31').then((valid) => {
        // console.warn("PID value is",valid) result
        setResult31(valid)
      });
    const goBack = () => {
    ...
    return (
        <View style={styles.container}>
            <SafeAreaView>
                ...
                <View style={{height:hp(28),width:wp(80),marginTop:hp(2),marginBottom:hp(8),
...
<View>
                ...
                <View style={styles.hbnButton}>
                    ...
                    <TouchableOpacity style={styles.printButton} >
                        <Text style={{ color: '#ffffff', fontSize: 18, fontWeight: 'bold',marginTop:8 }}>Print Report</Text>
                    </TouchableOpacity>
